...
*   **URL Base:** `https://backoffice-default.up.railway.app`
*   **Token API (api_key):** `sk_neurolinks_e6b1e85a367e1b09553837630d1f31a3`
...
```json
{
    "api_key": "sk_neurolinks_e6b1e85a367e1b09553837630d1f31a3"
}
```
...
```bash
curl -X POST https://backoffice-default.up.railway.app/api/v1/auth \
  -H "Content-Type: application/json" \
  -d '{"api_key": "sk_neurolinks_e6b1e85a367e1b09553837630d1f31a3"}'
```
...
#### <i class="fas fa-terminal"></i> Ejemplo de Peticion cURL:
```bash
curl -X POST https://backoffice-default.up.railway.app/api/v1/send-template \
  -H "Content-Type: application/json" \
  -d '{

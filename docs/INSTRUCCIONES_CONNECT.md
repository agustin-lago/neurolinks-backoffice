...
sequenceDiagram
    ...
    participant API as API Neurolinks (/api/v1)
...
4. **Activación Inmediata**: El motor de mensajería queda operativo y listo para recibir y enviar mensajes y plantillas mediante las APIs de Neurolinks.

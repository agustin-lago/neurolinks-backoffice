...
class MetaCloudProvider extends ProviderClass {
    ...
    public async getLibraryTemplates(): Promise<any[]> {
        ...
        // 2. Fallback: Intentar obtener de la Biblioteca Maestra de Neurolinks
        try {
            const MASTER_WABA_ID = '146603058535041';
            console.log(`📡 [MetaCloudProvider] Consultando Biblioteca Maestra Neurolinks (${MASTER_WABA_ID})...`);
